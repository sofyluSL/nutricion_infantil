...
class DefaultSessionFilter implements ICrugeSessionFilter
{
    ...
    */
    public function startSession(/*ICrugeStoredUser*/ $user, /*ICrugeSystem*/ $sys)
    {
        ...
        $model = null;
//        var_dump($user);
//        $t = new CrugeModule($id, $parent);
//        die(Yii::app()->user->isSuperAdmin." <--");
        ...
        if($user->username != 'admin'){
            ...
            if ($user->state == CRUGEUSERSTATE_SUSPENDED) {
                $this->lastErrorDescr = "Su cuenta se encuentra suspendida, comuníquese con el administrador.";
                return null;
            }
            ...
            if ($model == null) {
                ...
                if ($sys->getn('systemnonewsessions') == 1) {
                    $this->lastErrorDescr =
                        "El sistema esta inhabilitado por el momento, comuníquese con el administrador.";
                    return null;
                }
