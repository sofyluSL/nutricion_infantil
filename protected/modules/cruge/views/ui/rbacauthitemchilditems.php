<?php 
	...
	// titulos
	echo "<legend>".ucfirst($model->name)." (".
		CrugeTranslator::t($rbac->getAuthItemTypeName($model->type)).")</legend>";
	...
	if(count($operaciones) > 0){
		...
		//
		$listacatg = array();
		$listacatg['1'] = CrugeTranslator::t('Módulos');
...
//			$listacatg[$controllerName] = $controllerName;
		$listacatg['2'] = CrugeTranslator::t('Usuarios');
